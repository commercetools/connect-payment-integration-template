...
export class PurchaseOrder extends BaseComponent {
  ...
  private _getTemplate() {
    ...
    <p>Please enter a single authorized purchase order number generated by our organization. The PO number and payment instructions will appear on the invoice.</p>
